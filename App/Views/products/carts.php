  ...
  <section class="content-container">
    ...
    <div class="content">
      ...
      <div class="invoice">
                ...
                <?php foreach($data->cart as $cart):?>
                  ...
                  <tr>
                      ...
                      <td class="action-fields">
                          ...
                          <a class="delete" href="/invoice/delete_cart/<?=$cart->product_id;?>"><i class="fa fa-times"></i></a>
        ...
        <input type="submit" name="process-cart" value="Process Payment" class="btn btn-lg btn-success">
      </form>
