          ...
          <form action="" method="post" class="profile-form" enctype="multipart/form-data">
            <div class="row">
              <div class="form-group">
                ...
                <div class="input_field"><input type="text" name="code" class="code" placeholder="Enter Product Code" value="<?=$product->code;?>"></div>
              </div>
              <div class="form-group">
                <div class="field_label"><label>Title</label> : </div>
                <div class="input_field"><input type="text" name="title" class="title" placeholder="Enter Title" value="<?=$product->title;?>"></div>
              </div>
              <!-- <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input_field">
                  <select name="company" id="company" class="company form-control">
                    ...
                    ?>
                    <?php if($company->id == $product->company):?>
              ...
              <div class="form-group">
                ...
                <div class="input_field"><input type="number" name="price" class="price" placeholder="Enter Your Price" value="<?=$product->price;?>"></div>
              </div>
              <div class="form-group">
                <div class="field_label"><label>Currency</label> : </div>
                <div class="input_field"><input type="text" name="currency" class="currency" placeholder="Enter Currency" value="<?=$product->currency;?>"></div>
              </div>
              <div class="form-group">
                ...
                <div class="input_field">
                  <select name="status" id="status" class="status form-control">
                    ...
                    ?>
                    <?php if($availability->code == $product->status):?>
            ...
            <div class="update_profile_container text-center">
              ...
              <input type="submit" name="update_product" value="Update Product" id="create_product" class="btn btn-lg btn-success">
            </div>
          </form>
        <?php endif;?>
        </div>
